<template>
    <div class="relative">
        <img src="@/assets/howto3.jpg" class="absolute inset-0 object-cover w-full h-full" alt="" />
        <div class="relative bg-gray-900 bg-opacity-75">
            <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div class="flex flex-col items-center justify-between xl:flex-row">
                    <div class="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                            Forgot Password<br class="hidden md:block" />
                            But don't forget <span class="text-teal-accent-400">Memory</span>
                        </h2>
                        ...
                        <div class="bg-white rounded shadow-2xl p-7 sm:p-10">
                            ...
                            <Form @submit.prevent="onFormSubmit()">
                                <div class="mb-1 sm:mb-2">
                                    <ul class="flex space-x-4 lg:flex">
                                        <li><label for="email" class="inline-block mb-1 font-medium">E-mail</label></li>
                                        <li><ErrorMessage class="text-red-500" name="email"/></li>
                                    </ul>
                                    <Field
                                ...
                                <div class="mt-4 mb-2 sm:mb-4">
                                    ...
                                    >
                                        <ul class="flex items-center space-x-2 lg:flex">
                                            <li>Email Password Reset Link</li>
